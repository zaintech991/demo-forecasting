...
def generate_mock_forecast(
    city_id: int, store_id: int, product_id: int, days: int = 30
):
...
@app.get(
    "/api/promotions/impact/{store_id}/{product_id}",
    response_model=PromotionAnalysisResponse,
)
