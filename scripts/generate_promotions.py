...
def generate_promotion_data(
    num_promotions=100, start_date="2022-01-01", end_date="2022-12-31"
):
    """
...
def main():
    ...
    parser.add_argument(
        "--output", type=str, default="promotions.csv", help="Output CSV file"
    )
    parser.add_argument(
        "--start-date",
        type=str,
        default="2022-01-01",
        help="Promotion start date range (YYYY-MM-DD)",
    )
    parser.add_argument(
        "--end-date",
        type=str,
        default="2022-12-31",
        help="Promotion end date range (YYYY-MM-DD)",
    )
