    ...
    for attempt in range(max_retries):
        try:
            ...
            if attempt < max_retries - 1:
                ...
                print(
                    "Please check your database credentials, network connection, and ensure the database is accessible."
                )
    ...
    try:
        ...
        if supabase:
            try:
                ...
                print(
                    "Supabase connection established but query failed. This may be normal if the _dummy table doesn't exist."
                )
