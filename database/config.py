...
POOL_CONFIG = {
    ...
    'max_inactive_connection_lifetime': float(os.getenv('DB_POOL_MAX_INACTIVE_CONNECTION_LIFETIME', '300')),
}

# Cache settings
CACHE_CONFIG = {
    'ttl': int(os.getenv('CACHE_TTL', '300')),  # Time to live in seconds
    'max_size': int(os.getenv('CACHE_MAX_SIZE', '1000')),  # Maximum number of items in cache
}
